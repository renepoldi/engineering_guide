# -*- coding: utf-8 -*-
"""
Created on Thu Jul 12 15:02:25 2018
...
try:
  ...
  print("FATAL","Unable to load serial port: \"{}\".")  
  print("DEBUG","Error was : {}".format(e))
  SerialData="NoSerial"
# -------- Main Program Loop -----------
while done==False:
    ...
    for i in range(joystick_count):
        ...
        try:
         ...
         # Read into the serial buffer if there is somthing inside
          serdata=False
          try:
                serdata=ser.inWaiting()#pyserial v3.x
          except:
             pass
        ...
        # mit decode in normalen string konvertieren.
          if serdata:
            SerialData = ser.read()
            SerialData = SerialData.decode(encoding='UTF-8')
        except Exception as e:
           print("Error {}".format(e))
    
        textPrint.print(screen, "SerialData: {}".format(SerialData))
        textPrint.unindent()
